...
');
?>
<form action="<?php echo Route::_('index.php?option=com_actionlogs&view=actionlogs'); ?>" method="post" name="adminForm"
      id="adminForm">
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
								<span class="hasTooltip"
                                      title="<?php echo HTMLHelper::_('date', $item->log_date, Text::_('DATE_FORMAT_LC6')); ?>">
...
<form action="<?php echo Route::_('index.php?option=com_actionlogs&view=actionlogs'); ?>" method="post"
